  ...
  public class Program
  {
    ...
    static Logger SetUpLogging()
    {
      ...
      else // Log to Logzio
      {
        ...
        loggingConfig.AddRule(LogLevel.Error, LogLevel.Fatal, logzioTarget);

        //Log everything debug and above for custom logs
        loggingConfig.AddRule(LogLevel.Debug, LogLevel.Fatal, logzioTarget, "Crossroads.*");
        ...
        //Log everything debug and above for custom logs
        loggingConfig.AddRule(LogLevel.Debug, LogLevel.Fatal, consoleTarget, "Crossroads.*");
